  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4 text-center">
        ...
        <h2 className="text-2xl font-black text-gray-800 mb-2">Accès refusé</h2>
        <p className="text-gray-500 mb-6 max-w-xs">Vous n'avez pas les permissions pour accéder à cette section.</p>
          ...
          <header className="h-16 flex items-center justify-between border-b border-gray-100 px-4 md:px-6 bg-white sticky top-0 z-30 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:flex items-center gap-1.5 text-sm">
                ...
                <span className="text-gray-700 font-semibold">Tableau de bord</span>
              </div>
            </div>
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="flex items-center gap-2.5 pl-3 border-l border-gray-100">
                ...
                <div className="hidden sm:block">
                  <div className="text-sm font-bold text-gray-800 leading-tight">{displayName}</div>
                  <div className="text-[10px] text-blue-600 font-bold uppercase tracking-wider">Admin</div>
                </div>
              </div>
            </div>
          </header>
